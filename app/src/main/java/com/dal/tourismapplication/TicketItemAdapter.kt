...
class TicketItemAdapter(var ticketsList: ArrayList<JSONObject>, var context: Context):
    RecyclerView.Adapter<TicketItemAdapter.ViewHolder>(), Serializable{
    ...
    override fun onBindViewHolder(
        ...
        val obj: JSONObject = ticketsList.get(position)
        try {
        ...
        holder.parent_layout.setOnClickListener(View.OnClickListener {
            val intent = Intent(context, SampleTicketActivity::class.java)
